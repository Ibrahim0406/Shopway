            ...
            <div className='w-[70%]'>
                <div className='flex gap-8'>
                    ...
                    {userInfo?.addressList &&
                        <div>
                            <p>{userInfo?.addressList?.[0]?.name || "John"}</p>
                            <p>{userInfo?.addressList?.[0]?.street || "Brijestova 16b"}</p>
                            <p>{userInfo?.addressList?.[0]?.city || "Zenica"},{userInfo?.addressList?.[0]?.state || "California"} {userInfo?.addressList?.[0]?.zipCode || "72000"}</p>
                        </div>}
                </div>
